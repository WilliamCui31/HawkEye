	...
	render: function(){
		...
		if(this.state.operateFormData) {
			...
			sexComponent=<StatisticsGrid
				...
				width="500"
				explain="根据投资金额排序"
				theads={[{name:"性别",width:"20%"},{name:"投资人数",width:"20%"},{name:"投资金额",width:"20%"},{name:"投资金额占比",width:"20%"},{name:"投资人数占比"}]}
				data={sexData}
			/>;
			...
			borrowTypeComponent=<StatisticsGrid
				...
				width="500"
				explain=""
				theads={[{name:"借贷产品",width:"15%"},{name:"借款人数",width:"15%"},{name:"借款总次数",width:"20%"},{name:"借款总额",width:"30%"},{name:"借款总额占比"}]}
				data={borrowTypeData}
			/>;
